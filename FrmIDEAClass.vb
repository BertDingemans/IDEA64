...
Public Class FrmIDEAClass
    ...
    Private Sub ButtonGenerate_Click(ByVal sender As Object, ByVal e As EventArgs) Handles ButtonGenerate.Click
        ...
        Else
            ...
            Else
                ...
                End If
                If Not objNew.Stereotype.Contains("ArchiMate") Then
                    For Each item In Me.ListBoxAttributes.CheckedItems
                        ...
                        objAttrib.Update()
                    Next
                    'this should only be created when the attribute associations are not
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        For Each item In Me.ListBoxAttributes.CheckedItems
            ...
            Dim oTV As EA.AttributeTag
            oTV = objAttrib.TaggedValues.AddNew("FormFactory_IsColumn", "")
            objAttrib.Update()
        Next
    End Sub
End Class