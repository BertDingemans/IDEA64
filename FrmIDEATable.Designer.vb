...
Partial Public Class FrmIDEATable
    ...
    Private Sub InitializeComponent()
        ...
        Me.ListBoxAttributes.Size = New System.Drawing.Size(344, 259)
        Me.ListBoxAttributes.TabIndex = 12
        Me.ToolTipTable.SetToolTip(Me.ListBoxAttributes, "List of available attributes or columns for selected item")
        '
        ...
        Me.ToolTipTable.SetToolTip(Me.ComboBoxExistingRefactor, "Refactor to an existing element")
        '
        ...
        Me.ToolTipTable.SetToolTip(Me.TextBoxNewRefactor, "Refactor to a new entity")
        '
        ...
        Me.ToolTipTable.SetToolTip(Me.ButtonRefactor, "Refactor the attributes to the selected element")
    ...
    " in one easy step."
        ...
        Me.ToolTipTable.SetToolTip(Me.ListBoxType, "Generate a new element based on the stereotype")
        '
        'ButtonGenerate
        '
        ...
        Me.ToolTipTable.SetToolTip(Me.ButtonGenerate, "Execute the copy and creating step")
        ...
        Me.ToolTipTable.SetToolTip(Me.ComboBoxExistingEntity, "Select the element to write attibutes to")
        '
        'TabPageRefactor
        '
    ...
    "ne easy step."
        ...
        Me.ToolTipTable.SetToolTip(Me.RadioButtonExistingEntity, "Add attributes to existing element")
        ...
        Me.ToolTipTable.SetToolTip(Me.TextBoxNewEntity, "Create a new entity based on the generator")
        '
        'TabPageGenerate
        '
        ...
        Me.ToolTipTable.SetToolTip(Me.Label5, "Place the element in a target package")
        '
        ...
        Me.ToolTipTable.SetToolTip(Me.ButtonLoad, "Load attributes for selected element")
        ...
        Me.ToolTipTable.SetToolTip(Me.ComboBoxElement, "Select the table element to load in the listbox")
        '
        'ButtonUnselectAll
        '
        ...
        'ToolTipTable
        '
        Me.ToolTipTable.IsBalloon = True
        '
        'FrmIDEATable
        '
