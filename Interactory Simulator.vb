...
Public Class Interactory_Simulator
    ...
    Function ValidateActiveRow() As Boolean
        ...
        Try
            ...
            If ActiveDataRow.Table.Columns.Contains("Validation") Then
                If Me.ActiveId = "NEW" Then
                    Me.ActiveDataRow.Table.Rows.Add(Me.ActiveDataRow)
                    Me.ActiveDataRow.Table.AcceptChanges()
                    Me.ActiveId = Me.ActiveDataRow(Me.ActiveDataRow.Table.PrimaryKey(0).ToString())
                End If
                strMessage += vbCrLf + "--" + vbCrLf + ActiveDataRow("Validation").ToString()
            End If
