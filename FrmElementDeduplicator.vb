...
Public Class FrmElementDeduplicator
    ...
    Private Sub ButtonDeDuplicate_Click(ByVal sender As Object, ByVal e As EventArgs) Handles ButtonDeDuplicate.Click
        ...
        Try
            If DLA2EAHelper.IsUserGroupMember(Me.Repository, "Administrators") Then
    ...
    End Function
    Sub LoadAttributes()
        Dim strSql As String = "select [name], [type], [scope], [notes], null as Dupl_status, [id] from t_attribute where object_id = {0} order by [pos], [name], [type]"
