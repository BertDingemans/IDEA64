...
Public Class FrmDiagramDuplicator
    ...
    Private Sub ButtonClone_Click(ByVal sender As Object, ByVal e As EventArgs) Handles ButtonClone.Click
        ...
        Dim blnWarning As Boolean = My.Settings.SuppresWarningDialog
        ...
        Try
            ...
            End If
            objRoot = Me.Repository.GetPackageByID(Me.oDiagram.PackageID)
            ...
            If Me.CheckBoxKeepOriginal.Checked = False Then
                ...
                Me.Repository.RefreshModelView(objRoot.PackageID)

                Me.ProgressBarClone.Increment(1)
            End If
            My.Settings.SuppresWarningDialog = blnWarning
            My.Settings.Save()
    ...
    Private Sub FrmDiagramDuplicator_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.Savetranslations()
    End Sub
